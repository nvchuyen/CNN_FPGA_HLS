; ModuleID = 'F:/NVChuyen/CNN/VitisHLS/pooling/pooling_cnn/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_pooling_cnn_ir(%"class.hls::stream"* %out, %"class.hls::stream"* %in) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_pooling_cnn_hw(%"class.hls::stream"* %out_copy1, %"class.hls::stream"* %in_copy2)
...
declare void @apatb_pooling_cnn_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @pooling_cnn_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @pooling_cnn_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @pooling_cnn_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
