...
architecture behav of conv_layer2 is 
    ...
    signal grp_convolution_fu_24_ap_start : STD_LOGIC;
    signal grp_convolution_fu_24_ap_done : STD_LOGIC;
    signal grp_convolution_fu_24_ap_idle : STD_LOGIC;
    signal grp_convolution_fu_24_ap_ready : STD_LOGIC;
    signal grp_convolution_fu_24_in_stream_V_TREADY : STD_LOGIC;
    signal grp_convolution_fu_24_out_stream_V_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_convolution_fu_24_out_stream_V_TVALID : STD_LOGIC;
    signal grp_convolution_fu_24_out_stream_V_TREADY : STD_LOGIC;
    signal grp_convolution_fu_24_ap_start_reg : STD_LOGIC := '0';
    ...
    component conv_layer2_convolution IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component conv_layer2_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_convolution_fu_24 : component conv_layer2_convolution
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    regslice_both_in_stream_V_U : component conv_layer2_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_U : component conv_layer2_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    grp_convolution_fu_24_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_convolution_fu_24_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_convolution_fu_24_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_convolution_fu_24_ap_ready = ap_const_logic_1)) then 
                    grp_convolution_fu_24_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, grp_convolution_fu_24_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4, regslice_both_out_stream_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_convolution_fu_24_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
                    ap_NS_fsm <= ap_ST_fsm_state4;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
            when ap_ST_fsm_state4 => 
                if (((regslice_both_out_stream_V_U_apdone_blk = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state4;
                end if;
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state4, regslice_both_out_stream_V_U_apdone_blk)
    begin
        if (((regslice_both_out_stream_V_U_apdone_blk = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state4, regslice_both_out_stream_V_U_apdone_blk)
    begin
        if (((regslice_both_out_stream_V_U_apdone_blk = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    grp_convolution_fu_24_ap_start <= grp_convolution_fu_24_ap_start_reg;
    grp_convolution_fu_24_out_stream_V_TREADY <= (out_stream_V_TREADY_int_regslice and ap_CS_fsm_state3);
    in_stream_V_TREADY <= regslice_both_in_stream_V_U_ack_in;

    in_stream_V_TREADY_int_regslice_assign_proc : process(grp_convolution_fu_24_in_stream_V_TREADY, ap_CS_fsm_state3)
    begin
