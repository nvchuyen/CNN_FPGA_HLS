; ModuleID = 'E:/CMC/CNN/VitisHLS/input_cnn/Input_cnn/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_input_cnn_ir(%"class.hls::stream"* %out_str, i1* %enable) local_unnamed_addr #0 {
entry:
  %out_str_copy1 = alloca %"class.hls::stream", align 512
  %enable_copy = alloca i1, align 512
  call fastcc void @copy_in(%"class.hls::stream"* %out_str, %"class.hls::stream"* nonnull align 512 %out_str_copy1, i1* %enable, i1* nonnull align 512 %enable_copy)
  call void @apatb_input_cnn_hw(%"class.hls::stream"* %out_str_copy1, i1* %enable_copy)
  call fastcc void @copy_out(%"class.hls::stream"* %out_str, %"class.hls::stream"* nonnull align 512 %out_str_copy1, i1* %enable, i1* nonnull align 512 %enable_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i1* readonly, i1* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream"*, %"class.hls::stream"* noalias align 512, i1*, i1* noalias readonly align 512) unnamed_addr #6 {
entry:
...
declare void @apatb_input_cnn_hw(%"class.hls::stream"*, i1*)

define void @input_cnn_hw_stub_wrapper(%"class.hls::stream"*, i1*) #7 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, i1* null, i1* %1)
  call void @input_cnn_hw_stub(%"class.hls::stream"* %0, i1* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, i1* null, i1* %1)
  ret void
}

declare void @input_cnn_hw_stub(%"class.hls::stream"*, i1*)
