; ModuleID = 'F:/NVChuyen/CNN/VitisHLS/input_fc/input_fc/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_input_fc_ir(%"class.hls::stream"* %out) local_unnamed_addr #0 {
entry:
  %out_copy1 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %out, %"class.hls::stream"* nonnull align 512 %out_copy1)
  call void @apatb_input_fc_hw(%"class.hls::stream"* %out_copy1)
  call fastcc void @copy_out(%"class.hls::stream"* %out, %"class.hls::stream"* nonnull align 512 %out_copy1)
  ret void
}
...
declare void @apatb_input_fc_hw(%"class.hls::stream"*)

define void @input_fc_hw_stub_wrapper(%"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0)
  call void @input_fc_hw_stub(%"class.hls::stream"* %0)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0)
  ret void
}

declare void @input_fc_hw_stub(%"class.hls::stream"*)
