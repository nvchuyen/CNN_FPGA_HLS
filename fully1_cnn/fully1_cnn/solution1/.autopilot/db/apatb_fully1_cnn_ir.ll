; ModuleID = 'F:/NVChuyen/CNN/VitisHLS/fully1_cnn/fully1_cnn/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_fully1_cnn_ir(%"class.hls::stream"* %in, %"class.hls::stream"* %out) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_fully1_cnn_hw(%"class.hls::stream"* %in_copy1, %"class.hls::stream"* %out_copy2)
...
declare void @apatb_fully1_cnn_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @fully1_cnn_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @fully1_cnn_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @fully1_cnn_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
