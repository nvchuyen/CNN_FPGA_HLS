; ModuleID = 'E:/CMC/CNN/VitisHLS/conv_layer1/conv_layer1/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_conv_layer1_ir(%"class.hls::stream"* %in_stream, %"class.hls::stream"* %out_stream) local_unnamed_addr #0 {
entry:
  %in_stream_copy1 = alloca %"class.hls::stream", align 512
  %out_stream_copy2 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %in_stream, %"class.hls::stream"* nonnull align 512 %in_stream_copy1, %"class.hls::stream"* %out_stream, %"class.hls::stream"* nonnull align 512 %out_stream_copy2)
  call void @apatb_conv_layer1_hw(%"class.hls::stream"* %in_stream_copy1, %"class.hls::stream"* %out_stream_copy2)
  call fastcc void @copy_out(%"class.hls::stream"* %in_stream, %"class.hls::stream"* nonnull align 512 %in_stream_copy1, %"class.hls::stream"* %out_stream, %"class.hls::stream"* nonnull align 512 %out_stream_copy2)
  ret void
}
...
declare void @apatb_conv_layer1_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @conv_layer1_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @conv_layer1_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @conv_layer1_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
