...
architecture behav of conv_layer1 is 
    ...
    component conv_layer1_convolution IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component conv_layer1_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    grp_convolution_fu_24 : component conv_layer1_convolution
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    regslice_both_in_stream_V_U : component conv_layer1_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_out_stream_V_U : component conv_layer1_regslice_both
    generic map (
        DataWidth => 32)
    port map (
        ap_clk => ap_clk,
