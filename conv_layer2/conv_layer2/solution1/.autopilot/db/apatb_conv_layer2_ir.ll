; ModuleID = 'E:/CMC/CNN/VitisHLS/conv_layer2/conv_layer2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_conv_layer2_ir(%"class.hls::stream"* %in_stream, %"class.hls::stream"* %out_stream) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_conv_layer2_hw(%"class.hls::stream"* %in_stream_copy1, %"class.hls::stream"* %out_stream_copy2)
...
declare void @apatb_conv_layer2_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @conv_layer2_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @conv_layer2_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @conv_layer2_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
