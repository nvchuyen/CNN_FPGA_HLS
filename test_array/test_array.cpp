...
void test_array(hls::stream<float24_t> &in, hls::stream<float24_t> &out,
		float *test_val2,
		float24_t *test_bias ) {
#pragma HLS INTERFACE axis port=in
#pragma HLS INTERFACE axis port=out

#pragma HLS array_reshape variable=test_val2 block factor=4 dim=4
#pragma HLS array_reshape variable=test_bias block factor=4 dim=1
#pragma HLS INTERFACE ap_ctrl_none port=return
	...
	static const float24_t bias[8] = { -0.4841, -0.5488, -0.1868, -0.4800, -0.2518, -0.3664, -0.3803, -0.1135 };

	static const float24_t weight [8][1][4][4] =
