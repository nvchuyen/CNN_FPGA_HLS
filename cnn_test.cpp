...
void cnn( hls::stream<float24_t> &out_stream, hls::stream<float24_t> &in_stream);
...
int main()
{
	...
	float24_t fc_layer2_out[CONV_ACT_SIZE];
	...
	cnn( out_stream, in_stream);

	for(i = 0; i < CONV_ACT_SIZE; i++)
	{
