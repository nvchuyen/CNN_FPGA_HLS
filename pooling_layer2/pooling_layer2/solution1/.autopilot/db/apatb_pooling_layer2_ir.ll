; ModuleID = 'E:/CMC/CNN/VitisHLS/pooling_layer2/pooling_layer2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_pooling_layer2_ir(%"class.hls::stream"* %out, %"class.hls::stream"* %in) local_unnamed_addr #0 {
entry:
  %out_copy1 = alloca %"class.hls::stream", align 512
  %in_copy2 = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %out, %"class.hls::stream"* nonnull align 512 %out_copy1, %"class.hls::stream"* %in, %"class.hls::stream"* nonnull align 512 %in_copy2)
  call void @apatb_pooling_layer2_hw(%"class.hls::stream"* %out_copy1, %"class.hls::stream"* %in_copy2)
  call fastcc void @copy_out(%"class.hls::stream"* %out, %"class.hls::stream"* nonnull align 512 %out_copy1, %"class.hls::stream"* %in, %"class.hls::stream"* nonnull align 512 %in_copy2)
  ret void
}
...
declare void @apatb_pooling_layer2_hw(%"class.hls::stream"*, %"class.hls::stream"*)

define void @pooling_layer2_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @pooling_layer2_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @pooling_layer2_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*)
